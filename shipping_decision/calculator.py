...
class FreightCalculator:
    ...
    FREIGHT_CLASS_TABLE = [
        ...
        (12, 100),     # 10-12 lb/cu ft = Class 100
        (15, 92.5),    # 12-15 lb/cu ft = Class 92.5
        (22.5, 85),    # 15-22.5 lb/cu ft = Class 85
        (30, 70),      # 22.5-30 lb/cu ft = Class 70
        (35, 65),      # 30-35 lb/cu ft = Class 65
        (50, 60),      # 35-50 lb/cu ft = Class 60
        (float('inf'), 50)  # 50+ lb/cu ft = Class 50
    ]
